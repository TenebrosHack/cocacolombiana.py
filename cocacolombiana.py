#code by Tux
#TenebrosHack
#este script es para mis amigos Colombianos
""" ellos son buenos aunque sean narcos por eso este script lleva ese name
code writting by Vampy Security"""
import  os
import  webbrowser 

print("hola usuario Colombiano")
...
if opcion == 1:
        ...
        os.system('apt install python python2 perl php ruby apache2 -y')
elif opcion == 5:
        os.system('apt install git curl wget vim figlet -y')
else:
        print("esta opcion no es valida estas muy drogado")   
